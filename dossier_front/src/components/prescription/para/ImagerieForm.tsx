...
import { creerPrescriptionImagerie } from '@/lib/prescriptionApi';
          ...
          <div className="mbox" style={{ maxWidth: 600, width: '95%', maxHeight: '85vh', overflowY: 'auto' }}>
            ...
            <div style={{ padding: '20px' }}>
              ...
              <div style={{ marginBottom: 16 }}>
                ...
                {validatedPrescription.questionRadio && (
                  <div style={{ background: '#fff', border: '1px solid var(--bdr)', borderRadius: 10, padding: '12px 14px', marginBottom: 8 }}>
                    <div style={{ fontSize: 14, fontWeight: 700, color: 'var(--txt)', marginBottom: 4 }}>Question pour le radiologue</div>
                    <div style={{ fontSize: 12, color: 'var(--txt2)' }}>{validatedPrescription.questionRadio}</div>
                  </div>
                )}
                {validatedPrescription.imgType === 'scan' && validatedPrescription.scanType && (
                  <div style={{ background: '#fff', border: '1px solid var(--bdr)', borderRadius: 10, padding: '12px 14px', marginBottom: 8, display: 'flex', alignItems: 'center', gap: 12 }}>
                    <div style={{ width: 36, height: 36, borderRadius: '50%', background: 'var(--navy-lt)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                      <span className="ms" style={{ fontSize: 18, color: 'var(--navy)' }}>document_scanner</span>
                    </div>
                    <div style={{ flex: 1 }}>
                      <div style={{ fontSize: 14, fontWeight: 700, color: 'var(--txt)', marginBottom: 4 }}>Scanner</div>
                      <div style={{ fontSize: 12, color: 'var(--txt2)' }}>{validatedPrescription.scanType}</div>
                      {validatedPrescription.scanPrecisions && <div style={{ fontSize: 11, color: 'var(--txt3)', marginTop: 2 }}>{validatedPrescription.scanPrecisions}</div>}
                    </div>
                  </div>
                )}
                {validatedPrescription.imgType === 'echo' && validatedPrescription.echoType && (
                  <div style={{ background: '#fff', border: '1px solid var(--bdr)', borderRadius: 10, padding: '12px 14px', marginBottom: 8, display: 'flex', alignItems: 'center', gap: 12 }}>
                    <div style={{ width: 36, height: 36, borderRadius: '50%', background: 'var(--navy-lt)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                      <span className="ms" style={{ fontSize: 18, color: 'var(--navy)' }}>radar</span>
                    </div>
                    <div style={{ flex: 1 }}>
                      <div style={{ fontSize: 14, fontWeight: 700, color: 'var(--txt)', marginBottom: 4 }}>Échographie</div>
                      <div style={{ fontSize: 12, color: 'var(--txt2)' }}>{validatedPrescription.echoType}{validatedPrescription.echoDoppler ? ' + Doppler' : ''}</div>
                      {validatedPrescription.echoPrecisions && <div style={{ fontSize: 11, color: 'var(--txt3)', marginTop: 2 }}>{validatedPrescription.echoPrecisions}</div>}
                    </div>
                  </div>
                )}
                {validatedPrescription.imgType === 'rx' && validatedPrescription.rxType && (
                  <div style={{ background: '#fff', border: '1px solid var(--bdr)', borderRadius: 10, padding: '12px 14px', marginBottom: 8, display: 'flex', alignItems: 'center', gap: 12 }}>
                    <div style={{ width: 36, height: 36, borderRadius: '50%', background: 'var(--navy-lt)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                      <span className="ms" style={{ fontSize: 18, color: 'var(--navy)' }}>radiology</span>
                    </div>
                    <div style={{ flex: 1 }}>
                      <div style={{ fontSize: 14, fontWeight: 700, color: 'var(--txt)', marginBottom: 4 }}>Radiographie</div>
                      <div style={{ fontSize: 12, color: 'var(--txt2)' }}>{validatedPrescription.rxType} ({validatedPrescription.rxIncidences?.join(', ')})</div>
                      {validatedPrescription.rxPrecisions && <div style={{ fontSize: 11, color: 'var(--txt3)', marginTop: 2 }}>{validatedPrescription.rxPrecisions}</div>}
                    </div>
                  </div>
                )}
                {validatedPrescription.imgType === 'geste' && validatedPrescription.gesteType && (
                  <div style={{ background: '#fff', border: '1px solid var(--bdr)', borderRadius: 10, padding: '12px 14px', marginBottom: 8, display: 'flex', alignItems: 'center', gap: 12 }}>
                    <div style={{ width: 36, height: 36, borderRadius: '50%', background: 'var(--navy-lt)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                      <span className="ms" style={{ fontSize: 18, color: 'var(--navy)' }}>colorize</span>
                    </div>
                    <div style={{ flex: 1 }}>
                      <div style={{ fontSize: 14, fontWeight: 700, color: 'var(--txt)', marginBottom: 4 }}>Geste interventionnel</div>
                      <div style={{ fontSize: 12, color: 'var(--txt2)' }}>{validatedPrescription.gesteType}</div>
                      {validatedPrescription.gestePrecisions && <div style={{ fontSize: 11, color: 'var(--txt3)', marginTop: 2 }}>{validatedPrescription.gestePrecisions}</div>}
                    </div>
                  </div>
                )}
                {validatedPrescription.imgType === 'rxsp' && validatedPrescription.rxspType && (
                  <div style={{ background: '#fff', border: '1px solid var(--bdr)', borderRadius: 10, padding: '12px 14px', marginBottom: 8, display: 'flex', alignItems: 'center', gap: 12 }}>
                    <div style={{ width: 36, height: 36, borderRadius: '50%', background: 'var(--navy-lt)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                      <span className="ms" style={{ fontSize: 18, color: 'var(--navy)' }}>biotech</span>
                    </div>
                    <div style={{ flex: 1 }}>
                      <div style={{ fontSize: 14, fontWeight: 700, color: 'var(--txt)', marginBottom: 4 }}>Radio spéciale</div>
                      <div style={{ fontSize: 12, color: 'var(--txt2)' }}>{validatedPrescription.rxspType}</div>
                      {validatedPrescription.rxspPrep && <div style={{ fontSize: 11, color: 'var(--txt3)', marginTop: 2 }}>Préparation: {validatedPrescription.rxspPrep}</div>}
                      {validatedPrescription.rxspPrecisions && <div style={{ fontSize: 11, color: 'var(--txt3)', marginTop: 2 }}>{validatedPrescription.rxspPrecisions}</div>}
                    </div>
                  </div>
                )}
              </div>
